...
@interface ViewController () <ARSCNViewDelegate,MainFunctionViewDelegate,ConfirmOrderViewControllerDelegate>
...
- (void)clickSaveButton {
    ...
    NSMutableArray *array = [NSMutableArray arrayWithArray:self.picArray];
    [array addObject:_currentShotImage];
    self.picArray = array;
}
